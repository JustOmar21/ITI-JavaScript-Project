...
form.addEventListener("submit", function (e) {
  ...
  if (status) {
    ...
    let prod = new Product(prodID , productName.value , image.value , productPrice.value , description.value , quantity.value, categoryID.value );
    products.push(prod);
    localStorage.setItem("productID",Number(prodID)+1);
